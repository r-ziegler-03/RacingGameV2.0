...
namespace NWH.Common.CoM
{
    ...
    public class VariableCenterOfMass : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            if (dimensions.x < Vehicle.SMALL_NUMBER) dimensions.x = Vehicle.SMALL_NUMBER;
            if (dimensions.y < Vehicle.SMALL_NUMBER) dimensions.y = Vehicle.SMALL_NUMBER;
            if (dimensions.z < Vehicle.SMALL_NUMBER) dimensions.z = Vehicle.SMALL_NUMBER;
